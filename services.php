...
<p>Three starting points - portraits, weddings & events, and brand work - each shaped around how you actually want to be photographed.</p>
...
<main>
  <section class="service-detail" id="portraits">
    ...
    <div class="detail">
    <h2>Portraits</h2>
  <p>Solo, couple, or family sessions that feel like you - not a studio backdrop. Shot on location or in natural light indoors, with an unscripted, relaxed pace.</p>
  <ul class="checklist">
...
<p>Full-day coverage built around the moments that actually happen - not just the posed ones. From getting-ready shots to the last dance, documented start to finish.</p>
<ul class="checklist">
...
<p>Product, lifestyle, and headshot photography for growing businesses - clean, on-brand imagery ready for web, social, and print.</p>
<ul class="checklist">
...
<div class="faq-a">Most sessions book 2–4 weeks out; weddings and peak-season dates 3–6 months ahead.</div>
</div>
<div class="faq-item">
<button class="faq-q">What's the turnaround time?<span>+</span>
</button>
<div class="faq-a">Standard gallery delivery is within 10 business days; brand work has a fast 5-business-day option listed above.</div>
</div>
<div class="faq-item">
<button class="faq-q">Do you travel outside Dumaguete?<span>+</span>
</button>
<div class="faq-a">JIMS Photography is Dumaguete based and available worldwide. Travel planning can be discussed during enquiry.</div>
</div>
<div class="faq-item">
<button class="faq-q">What's the payment and deposit policy?<span>+</span>
</button>
<div class="faq-a">Payment details are not specified in the provided mockup; confirm the current deposit policy directly when enquiring.</div>
</div>
<div class="faq-item">
<button class="faq-q">Can I customize a package?<span>+</span>
</button>
<div class="faq-a">Yes - packages are starting points and can be shaped around your session through the enquiry and planning steps.</div>
</div>
</div>
</section>
<section class="cta">
...
<script src="script.js?v=20260908"></script>
</body>
</html>
